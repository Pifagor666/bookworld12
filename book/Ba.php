                            ...
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">                                
                                    ...
                                    <?php
                                        ...
                                        echo '<li><a href="login.php"><i class="fa fa-lock"></i> Вход</a></li>';
                                        }else{
                                        echo "Вы на сайте как ".$_SESSION['login'].'
                                        <form method="get">
                                            <input name="signOut" style="display:none" value="true">
                                            <button class="b1 col" type="submit" style="">Выйти</button>
                                        </form>';
                                        }
                                    ?>
                                </ul>
                ...
                <div class="row">
                            ...
                            <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="De.php">Детективы</a></h4>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="P.php">Поэзия</a></h4>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="Pr.php">Приключения</a></h4>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="Fa.php">Фантастика</a></h4>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="Fe.php">Фентази</a></h4>
                                    </div>
                                </div>
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="X.php">Художественная литература</a></h4>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <h2 class="title text-center">Басни</h2>
                            <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="images/shop/p13.jpg">
                                        <b>Жан де Лафонтен. Басни / Jean de La Fontaine: Fables | де Лафонтен Жан</b>
                                        <h2>190 руб.</h2>
                                        <a onclick="buy(13)" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>В корзину</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/shop/p14.jpg">
                                            <b>Басни. Крылов И. | Крылов Иван</b>
                                            <h2>399 руб.</h2>
                                            <a onclick="buy(14)" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>В корзину</a>
                                        </div>
                                    </div>
                                </div>
                            </div>                            
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/shop/p15.jpg">
                                            <b>Филипок. Рассказы, проверенные временем / Сборник рассказов для детей / Л. Толстой, В. Катаев, В. Даль, Е. Шварц, М. Зощенко, Л. Пантелеев | Толстой Лев Николаевич, Катаев Валентин</b>
                                            <h2>1288 руб.</h2>
                                            <a onclick="buy(15)" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>В корзину</a>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>                            
